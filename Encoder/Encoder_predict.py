...
from data.my_dataset import generate_dataset
...
def train(cfg, model, train_dataset, val_dataset, estimator, logger=None):
    ...
    train_sampler, val_sampler = initialize_sampler(cfg, train_dataset, val_dataset)  # 初始化训练和验证数据集的采样器。
    ...
    train_loader, val_loader = initialize_dataloader(cfg, train_dataset, val_dataset, train_sampler,
                                                     val_sampler)  # 初始化训练和验证的数据加载器
...
def main():
    ...
    print(test_dataset)
    cfg.train.checkpoint = r"D:\cv_paper\lesson\Dataset\Messidor_all/convnext_s_twice_best_validation_weights.pt"  # r"C:\Users\Haizeru\Desktop\best_dm_NFNet_f0.pt" "C:\Users\Haizeru\Desktop\修改文件\ResNet101\ResNet101(8288).pt"
    # "D:\cv_paper\lesson\Dataset\Messidor_all/regnet16_best_validation_weights.pt"  "C:\Users\Haizeru\Desktop\修改文件\ResNet101\ResNet101(8288).pt" r"D:\cv_paper\lesson\Dataset\Messidor_all/EffcientNetV2_M_best_validation_weights(8477).pt"
    # EffcientNetV2_M_best_validation_weights(8477).pt
