...
def parse_configuration():
    ...
    parser.add_argument(
        '-config',
        type=str,
        default='D:\GitHub\Fine_ResNet\Encoder\configs\Messidor.yaml',
...
def print_dataset_info(datasets):
    ...
    print('Valid:\t{}'.format(len(val_dataset)))
...
def select_target_type(y, criterion):
    if criterion in ['cross_entropy']:
        y = y.long()
    elif criterion in ['mean_square_error', 'mean_absolute_error']:
        y = y.float()
